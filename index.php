...
<html lang="fr">
    ...
    <body id="background_first">
        ...
        <div class="container mb-4">
            <header class="row">
                <div class="col-3" >
                    <a href="inscription.php"><img src="<?= 'assets/images/header/logo village green_1.png' ?>" class="img-fluid" alt="Image village green" id="logo"></a>
                </div>
                <div id="bande_1">
                    <div class="link">
            ...
            <section class="row pt-4 mb-4 pb-4">
                <div class="col-9">
                    <img src="<?= 'assets/images/body/pub guitare.png' ?>" alt="" class="img-fluid img_second">
                </div>
                <aside class="col-3">
                    <img src="<?= 'assets/images/body/banniere droite prix.png' ?>" alt="" class="img-fluid img_second">
                </aside>
            </section>
            <section class="row">
                <div class="col-12">
                    <img src="<?= 'assets/images/body/banniere centre 4 pictos.png' ?>" alt="" class="img-fluid img_banner_4_pictos">
                </div>
            </section>
            ...
            <section class="row  ">
                ...
                <img src="<?= 'assets/images/body/CATEGORIES guitare.png' ?>" alt="" class="img-fluid col-3 img_cat">

                <img src="<?= 'assets/images/body/CATEGORIES batterie.png' ?>" alt="" class="img-fluid col-3 img_cat">


                <img src="<?= 'assets/images/body/CATEGORIES piano.png' ?>" alt="" class="img-fluid col-3 img_cat">

                <img src="<?= 'assets/images/body/CATEGORIES micro.png' ?>" alt="" class="img-fluid col-3 img_cat">

                <img src="<?= 'assets/images/body/CATEGORIES sono.png' ?>" alt="" class="img-fluid col-3 img_cat">

                <img src="<?= 'assets/images/body/CATEGORIES cases.png' ?>" alt="" class="img-fluid col-3 img_cat">


                <img src="<?= 'assets/images/body/CATEGORIES cable.png' ?>" alt="" class="img-fluid col-3 img_cat">

                <img src="<?= 'assets/images/body/CATEGORIES saxo.png' ?>" alt="" class="img-fluid col-3 img_cat">
            ...
            <section class="row pt-2 pl-4 pr-4 background_section" id="section_last">
                <div class=" p-2 col-6">
                    ...
                    <div class="row">
                        <div class="col-4 pl-1 pr-1 pb-1">
                            <img src="<?= 'assets/images/body/TOP VENTES guitare.png' ?>" alt="" class="img-fluid">
                        </div>
                        <div class="col-4 pl-1 pr-1 pb-1">
                            <img src="<?= 'assets/images/body/TOP VENTES saxo.png' ?>" alt="" class="img-fluid">
                        </div>
                        <div class="col-4 pl-1 pr-1 pb-1">
                            <img src="<?= 'assets/images/body/TOP VENTES piano.png' ?>" alt="" class="img-fluid">
                        </div>
                    </div>
                ...
                <div class=" p-2 pl-4 col-6">
                    ...
                    <div class="row col-12">
                        <img src="<?= 'assets/images/body/partenaires 4 logos.png' ?>" alt="" class="img-fluid">
                    </div>
                </div>
